...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DvpLt24i.js
...
var styles_default = "/assets/styles-BZyd-z9A.css";
var APP_NAME = "KATHODE";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Terminal de engenharia reversa — canal direto com o interior."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-POVLWEYa.mjs");
