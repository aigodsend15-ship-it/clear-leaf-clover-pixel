...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Xm-_lHnI.mjs");
...
var manifest = { "0a24fdce91c4d303070791dcef28f305b3e16189a1867ddb5e375f36ae2d3cda": {
	functionName: "speakToCore_createServerFn_handler",
	importer: () => import("./ask-g3faco5P.mjs")
} };
